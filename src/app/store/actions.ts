...
export const UPLOAD_PRODUCT_IMAGE =
  '[Add Product Component] upload product image';
...
export const GET_USER = '[Settings Component] get current user';
export const GOTTEN_USER = '[Effect] gotten user';
export const REMOVE_FROM_CART = '[Cart Component] remove from cart';
...
export const uploadProductImageAction = createAction(
  ...
  props<{ file: File[]; product: Product }>()
);

export const passImageUrlAction = createAction(
  PASS_IMAGE_URL,
  props<{ urls: string[]; product: Product }>()
);
...
export const getProductsByCategoryAction = createAction(
  GET_PRODUCTS,
  props<{ category: string; offset: number }>()
);
...
export const gottenProductsAndCountAction = createAction(
  GOTTEN_PRODUCTS,
  props<{ products: Product[]; count: number }>()
);

export const gottenProductAction = createAction(
  GOTTEN_PRODUCT,
  props<{ product: Product }>()
);

export const userTokenValidationAction = createAction(
  USER_TOKEN_VALIDATION,
  props<{ token: string }>()
);

export const validationResultAction = createAction(
  VALIDATION_RESULT,
  props<{ valid: boolean }>()
);
...
export const signedupAction = createAction(
  SIGNEDUP_ACTION,
  props<{ user: User }>()
);
...
export const gottenTopSellersAction = createAction(
  GOTTEN_TOP_SELLERS,
...
export const addedToCartAction = createAction(
  ADDED_TO_CART,
  props<{ objectId: string }>()
);
...
export const gottenProductsFromCartAction = createAction(
  GOTTEN_FROM_CART,
  props<{ products: Product[] }>()
);
